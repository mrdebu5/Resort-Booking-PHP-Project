...
<html lang="en">
<head>
<title>Resort Booking Welcome page</title>
<!-- custom-theme -->
	...
	<div class="contact">
		<div class="container">
			...
			<div class="contact-form">
				<p style="font-family: Segoe Script, serif; font-size:20pt;">
					<b>Welcome to our site lets help the user to make thier holiday more special.</b>
				</p>			
