...
{
	$g_id=$_GET['g_id'];
	$q="delete from gallary where g_id='$g_id'";
	mysqli_query($cn,$q);
}
?>
<!--
...
<html lang="en">
<head>
<title>Resort Booking View Gallery Page</title>
<!-- custom-theme -->
		...
		<div class="container">
			...
			<div class="contact-form">
				<table class="table">
					...
					<?php
					$q="select * from gallary where hr_id='$hr_id'";
					...
					<tr>
						...
						<td><a href="edit_gallary.php?g_id=<?php print $row['g_id'];?>">Edit</a>|<a href="view_gallery.php?g_id=<?php print $row['g_id'];?>">Delete</a></td>
					<?php
					}
					?>
